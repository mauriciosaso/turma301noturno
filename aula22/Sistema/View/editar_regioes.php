...
<html lang="en">
  ...
  <body>
    ...
    <form action="../Services/validar_editar_action.php" method="post">
            ...
            <div class="col-md-7">
                ...
                <select class="form-select" name="pais">                
                    <?php while($opcoes_pais = $resultado_pais->fetch(PDO::FETCH_ASSOC)) :  ?>
                        ...
                        <?php 
                            if($opcoes_pais['id'] == $resultado_id['pais']){
                                echo ' selected';
                            }
                        ?>>
            ...
            <div class="col-md-7">
                ...
                <select class="form-select" name="estado">
                    <?php while($opcoes_estado = $resultado_estado->fetch(PDO::FETCH_ASSOC)) :  ?>
                        ...
                        <?php 
                            if($opcoes_estado['id'] == $resultado_id['estado']){
                                echo ' selected';
                            }
                        ?>>
            ...
            <div class="col-md-7">
                ...
                <select class="form-select" name="cidade">
                    <?php while($opcoes_cidade = $resultado_cidade->fetch(PDO::FETCH_ASSOC)) :  ?>
                        ...
                        <?php 
                            if($opcoes_cidade['id'] == $resultado_id['cidade']){
                                echo ' selected';
                            }
                        ?>>
        ...
        <div class="row">
            <div class="col-md-12">
                <button class="btn btn-warning" style="width: 100%; margin-top: 3%;" name="enviar2">Editar</button>
            </div>
        </div>
